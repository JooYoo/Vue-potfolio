    ...
    <v-container grid-list-md text-xs-left>
      <v-layout row wrap>
        <v-flex xs12 text-xs-center>
          <p class="display-2 font-weight-light">{{ProjectData.projects[2].title}}</p>
        ...
        <v-flex xs12>
          ...
          <p class="body-2 font-weight-regular">{{ProjectData.projects[2].concept}}</p>
        </v-flex>
        ...
        <v-flex xs12>
          ...
          <v-card class="blog-screenshot-card">
            <v-container grid-list-sm fluid>
              <v-layout row wrap>
                <v-flex
                  v-for="screenshot in ProjectData.projects[2].screenshots"
                  :key="screenshot.id"
                  xs4
                  d-flex
                >
          ...
          <v-card  class="blog-demos">
            <v-bottom-nav absolute color="transparent" height="100px;">
              <v-btn
                :href="demo.link"
                target="_blank"
                v-for="demo in ProjectData.projects[2].demos"
                :key="demo.id"
              >
                <span>{{demo.name}}</span>
